          ...
          <div className="row">
            <div className="col col-12 col-md-6 py-5 contact-col-size">
              <div className="d-flex align-items-start flex-column contact-col-1-size p-4 p-md-0">
                <div>
                  <h1 className="contact-form-heading display-4 fw-normal my-5">
                    What to Have a Free Session ?
                  </h1>
                  <p className="h4 fw-light me-5">
                    Reach out to us. We can make grow your business faster than
                    ever.
                  </p>
                </div>
